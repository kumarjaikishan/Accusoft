        ...
        <div className={` ${log.loader ? 'App overflow-hidden' : 'App'}`}>
            ...
            >
                ...
                <footer className=" mt-auto print:hidden">
                    <div className=" pt-2 pb-2 pr-2 fill-slate-200 border-t border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-end gap-6 text-xs font-semibold text-slate-500 dark:text-slate-400">
