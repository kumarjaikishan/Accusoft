...
const Login = () => {
    ...
    return (
        <>
            <div className="w-full min-h-screen overflow-hidden flex items-center justify-center bg-gradient-to-b from-blue-50 to-indigo-100 dark:from-slate-900 dark:to-slate-800 p-4">
                <div className="rounded-[20px] relative w-full max-w-md min-h-[520px] max-sm:min-h-max bg-white dark:bg-slate-800 shadow-2xl dark:shadow-none border border-gray-200 dark:border-white/5 dark:text-gray-100 overflow-hidden flex flex-col justify-start py-6">
                    <div className="w-full relative h-[70px] text-center flex justify-center mb-2 max-sm:hidden shrink-0">
                        <Leaf className="text-[4em]" style={{ color: "var(--maincolor)" }} />
                    </div>
