...
const Home = () => {
  ...
  const recentSpend = useMemo(
    () => [
      { title: "Amazon Purchase", category: "Shopping", amount: 2499 },
        ...
        <div className="bg-white shadow-sm rounded-xl p-6">
          ...
          {recentSpend.length > 0 ? (
            <div className="space-y-1">
              {recentSpend.map((item, index) => (
                <div
                  key={index}
                  className="flex justify-between items-center p-3 rounded-lg hover:bg-gray-200 transition"
                >
                  <div>
