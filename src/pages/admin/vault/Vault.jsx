                                    ...
                                    {item.decrypted?.id && (
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-100 dark:border-slate-800/80">
                                                ...
                                                <button
                                                    onClick={() => handleCopy(item.decrypted.id, idKey, "ID / Username")}
                                                    title="Copy ID"
                                        ...
                                        <div className="space-y-1">
                                            ...
                                            <div className="flex items-center justify-between p-2 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-100 dark:border-slate-800/80">
                                                ...
                                                <div className="flex items-center gap-1 shrink-0">
                                                    ...
                                                    <button
                                                        onClick={() => handleCopy(item.decrypted.password, passKey, "Password")}
                                                        title="Copy Password"
                                                        className="p-1.5 rounded-lg text-slate-400 hover:text-slate-700 dark:hover:text-slate-200 hover:bg-slate-200/60 dark:hover:bg-slate-800 transition-colors cursor-pointer"
                                                    >
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex flex-wrap items-center gap-3 flex-1">
                                    {/* ID / Username */}
                                    {item.decrypted?.id && (
                                        <div className="flex items-center justify-between gap-2 px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-100 dark:border-slate-800/80 min-w-[150px] max-w-xs">
                                    ...
                                    {/* Password */}
                                    {item.decrypted?.password && (
                                        <div className="flex items-center justify-between gap-2 px-3 py-1.5 rounded-xl bg-slate-50 dark:bg-slate-950/60 border border-slate-100 dark:border-slate-800/80 min-w-[170px] max-w-xs">
                                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">PASS</span>
                                            <span className="font-mono text-xs text-slate-700 dark:text-slate-200 truncate select-all">
                                                {isPassVisible ? item.decrypted.password : "••••••••••••"}
                                            </span>
                                    ...
                                    {Array.isArray(item.decrypted?.customFields) && item.decrypted.customFields.map((field, fIdx) => {
                                        ...
                                        return (
                                            <div 
                                                key={field.id || fIdx} 
                                                className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-indigo-50/60 dark:bg-indigo-950/40 border border-indigo-100 dark:border-indigo-900/40 text-xs"
                                            >
                                                <span className="font-semibold text-indigo-600 dark:text-indigo-400">{field.label}:</span>
                                                <span className="font-mono text-slate-700 dark:text-slate-200">{field.value}</span>
                                                {field.value && (
                                                    <button
                                                        onClick={() => handleCopy(field.value, fieldKey, field.label || "Field")}
                                                        title={`Copy ${field.label || "Value"}`}
